<template>
    <div>
        <el-table align="center" v-loading="loading" ref="multipleTable" :data="dataList" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="name" :label="$t('goods.price')" width="120">
            </el-table-column>
            <el-table-column prop="comments" :label="$t('goods.days')">
            </el-table-column>
            </el-table-column>
            <el-table-column prop="comments" :label="$t('goods.des')">
            </el-table-column>
